...
#tiff(paste0(inputdir,"heatplot_q0.1_logFC2.tif"))
...
dev.off()
#ggsave(paste0(inputdir,"heatplot_q0.05_logFC2.tiff"), heatplot(data, dend = c("both", "row", "column", "none"), margins=c(15,20),cols.default = TRUE, lowcol = "green", highcol = "red", scale="none",  classvec=NULL, classvecCol=NULL, classvec2=NULL, distfun=NULL, returnSampleTree=FALSE,method="ave", dualScale=TRUE, zlim=c(-3,3),scaleKey=TRUE),width = 20, height = 20, units = "cm", dpi = 300)
#dev.off()
